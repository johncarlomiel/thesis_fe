...
var AdminAuthComponent = /** @class */ (function () {
    function AdminAuthComponent(adminService, chatService, router, dataService) {
        ...
        this.isError = false;
        this.errorMsg = "";
        this.chatSocket = socket_io_client__WEBPACK_IMPORTED_MODULE_3__("http://localhost:5000/chat");
    }
...
module.exports = "td{\r\n    font-weight: bolder;\r\n}\r\nth{\r\n    font-size: 1.2em;\r\n    font-weight: bolder;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var AdminGraphGeneralComponent = /** @class */ (function () {
    function AdminGraphGeneralComponent(adminService, zone, router) {
        this.adminService = adminService;
        this.zone = zone;
        this.router = router;
        this.loader = false;
    ...
    AdminGraphGeneralComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_admin_service__WEBPACK_IMPORTED_MODULE_6__["AdminService"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgZone"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"]])
...
var AdminGraphComponent = /** @class */ (function () {
    function AdminGraphComponent(adminService, zone, router) {
        this.adminService = adminService;
        this.zone = zone;
        this.router = router;
        this.printing = false;
    ...
    AdminGraphComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_admin_service__WEBPACK_IMPORTED_MODULE_3__["AdminService"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgZone"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]])
    ], AdminGraphComponent);
...
var AdminMessagesComponent = /** @class */ (function () {
    ...
    function AdminMessagesComponent(chatService, userService, router) {
        this.chatService = chatService;
    ...
    AdminMessagesComponent.prototype.getNextBatch = function (event) {
        ...
        if (event === 0 && this.isInitialized) {
            ...
            this.limit += 10;
            setTimeout(function () {
                _this.chatService.getMessages(_this.selectedContact.convo_name, _this.limit)
    ...
    AdminMessagesComponent.prototype.getMessages = function (convo_name) {
        var _this = this;
        this.chatService.getMessages(convo_name, this.limit).subscribe(function (successData) {
            _this.messages = successData.reverse();
            setTimeout(function () {
    ...
    AdminMessagesComponent.prototype.getContacts = function () {
        var _this = this;
        this.chatService.getContacts().subscribe(function (successData) {
...
module.exports = "@import url('https://fonts.googleapis.com/css?family=Staatliches');\r\nh4,h5{\r\n    margin:0;\r\n    font-family: 'Staatliches', cursive;\r\n}\r\nh3{\r\n    margin: 0 0 0 0;\r\n    font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;\r\n}\r\n.printContent{\r\n    width:940px;\r\n    height:100vh;\r\n    page-break-inside:avoid !important;\r\n}\r\n@media print {\r\n    #message{\r\n        color:black;\r\n    }\r\n    #print_header{\r\n        letter-spacing:0.2em;font-weight: bold;color:grey !important; \r\n    }\r\n    .ui.progress {\r\n        background-image: none;\r\n        -webkit-print-color-adjust: exact;\r\n        box-shadow: inset 0 0;\r\n        -webkit-box-shadow: inset 0 0;\r\n      \r\n      \r\n      }\r\n    \r\n \r\n    html, body {\r\n      /*changing width to 100% causes huge overflow and wrap*/\r\n      height:100%; \r\n      background: #FFF; \r\n      font-size: 9pt;\r\n    }\r\n    table{\r\n        page-break-inside: avoid;\r\n    }\r\n    \r\n  \r\n\r\n  }\r\n.onepage {\r\n    page-break-after: always;\r\n  }\r\n.onepage:last-child {\r\n    page-break-after: avoid;\r\n  }\r\n:host::ng-deep.ui.progress .label{\r\n    font-size: 1.2em;\r\n}\r\n:host::ng-deep.ui.progress#R .label{\r\n    color:#F1463C !important;\r\n}\r\n:host::ng-deep.ui.progress#I .label{\r\n    color:#F79517 !important; \r\n}\r\n:host::ng-deep.ui.progress#A .label{\r\n    color:#FFCF00 !important; \r\n}\r\n:host::ng-deep.ui.progress#S .label{\r\n    color:#01723B !important; \r\n}\r\n:host::ng-deep.ui.progress#E .label{\r\n    color:#0073A5 !important; \r\n}\r\n:host::ng-deep.ui.progress#C .label{\r\n    color:#9279B7 !important; \r\n}\r\n:host::ng-deep.ui.progress#R .bar{\r\n    background:#F1463C !important;\r\n}\r\n:host::ng-deep.ui.progress#I .bar{\r\n    background:#F79517 !important; \r\n}\r\n:host::ng-deep.ui.progress#A .bar{\r\n    background:#FFCF00 !important; \r\n}\r\n:host::ng-deep.ui.progress#S .bar{\r\n    background:#01723B !important; \r\n}\r\n:host::ng-deep.ui.progress#E .bar{\r\n    background:#0073A5 !important; \r\n}\r\n:host::ng-deep.ui.progress#C .bar{\r\n    background:#9279B7 !important; \r\n}\r\n.code-rate{\r\n    padding: 10px;\r\n}\r\n.image-icon{\r\n    margin:5px;\r\n}\r\n#try {\r\n    -webkit-clip-path: polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%);\r\n    clip-path: polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%);\r\n }\r\n.containerBox {\r\n    position: relative;\r\n    text-align: center;\r\n    color: black;\r\n}\r\n.center-text {\r\n    position: absolute;\r\n    top: 50%;\r\n    left: 50%;\r\n    -webkit-transform: translate(-50%, -50%);\r\n            transform: translate(-50%, -50%);\r\n  }\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "\r\n\r\n.content_section{\r\n    position: absolute;\r\n    z-index: 1;\r\n    color: #f3f3f3;\r\n    top: 20%;\r\n    left: 8%;\r\n    right: 8%;\r\n\r\n  \r\n\r\n\r\n}\r\n#header-section::after{\r\n    content: '';\r\n    width: 100%;\r\n    height: 70vh;\r\n    background: url('showcase.jpg');\r\n    background-repeat: no-repeat;\r\n    background-size: cover;\r\n    background-position: center;\r\n    display: block;\r\n    filter: blur(5px);\r\n    -webkit-filter: blur(5px);\r\n    color: #f3f3f3;\r\n    transition: all 1000ms;\r\n}\r\n.content div#intro-title{\r\n    padding-top: 5%;\r\n}\r\n/* Defaults */\r\np{\r\n    font-size: 1.1rem;\r\n    font-weight: 400;\r\n}\r\nsection{\r\n    margin-bottom: 5%;\r\n}\r\n#gray-section{\r\n    padding: 7%;\r\n    margin-top: 5%;\r\n    background: #F5F7F8;\r\n    margin-bottom: 0;\r\n}\r\n/* Left Side */\r\nsection#gray-section div div#left{\r\n    border-top:#E6ECEE solid 1px;\r\n    border-right:#E6ECEE solid 1px;\r\n    height:300px;\r\n    padding-top: 55px;\r\n}\r\n/* Quote */\r\nsection#gray-section div div#left p#quote{\r\n    color: gray;\r\n    font-style: italic;\r\n    font-weight: 700;\r\n    font-size: 1.5em;\r\n}\r\n/* Left Side */\r\n/* Right Side */\r\nsection#gray-section div div#right{\r\n    border-top:#E6ECEE solid 1px;\r\n    border-left:#E6ECEE solid 1px;\r\n    height:300px;\r\n    padding-top: 55px;\r\n}\r\n/* Right Side */\r\n\r\n\r\n\r\n\r\n\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<!-- Header -->\n<app-header></app-header>\n\n<!-- Header -->\n<br>\n\n<!-- Section -->\n<section id=\"header-section\">\n  <div class=\"row container content_section\">\n    <div class=\"col l7\" id=\"intro-title\">\n      <h1 class=\"bolder center ui header\" style=\"color:white;font-size: 3.5rem\">What is the SDS?</h1>\n      <p class=\"center\" style=\"font-size:1.5rem\">The next generation of John Holland’s Self-Directed Search® (SDS®) is\n        a\n        career assessment and\n        exploration\n        tool that matches your aspirations, activities, and talents to the career choices and educational\n        opportunities\n        that fit you best.</p>\n    </div>\n    <div class=\"col l5\">\n\n    </div>\n\n  </div>\n\n\n</section>\n<!-- End of Section -->\n\n\n\n\n<!-- Section -->\n<section>\n  <h1 class=\"center bolder ui header primary\">How SDS Works</h1>\n  <p class=\"center\" style=\"color: gray\">Choose a career that based on your personality and skills</p>\n  <br>\n  <br>\n  <div class=\"ui grid container\">\n    <div class=\"four wide column\"></div>\n\n    <div class=\"eight wide column\">\n      <img src=\"assets/images/questions.png\" alt=\"\" class=\"responsive-img\" style=\"margin-right: 20px;\">\n      <h4 class=\"bolder primary ui header\">Answer</h4>\n      <p style=\"color: gray;font-weight: 500;\">Answer questions about what you like on following categories:\n        Activities, Occupations and Competencies </p>\n    </div>\n  </div>\n\n\n  <div class=\"ui grid container\">\n    <div class=\"four wide column\"></div>\n    <div class=\"eight wide column\">\n      <p style=\"text-align:right\"><img src=\"assets/images/evaluation.png\" class=\"responsive-img\" alt=\"\" style=\"margin-left: 20px;\"></p>\n      <h4 class=\"primary bolder ui header\">Evaluate</h4>\n      <p style=\"color:gray;font-weight: 500;\">Evaluate your answers based on RIASEC theory (Realistic, Investigative,\n        Artistic, Social, Enterprising, and Conventional) and get a code(s)</p>\n    </div>\n  </div>\n\n  <div class=\"ui grid container\">\n    <div class=\"four wide column\"></div>\n    <div class=\"eight wide column\">\n      <img src=\"assets/images/menu.png\" alt=\"\" class=\"responsive-img left\" style=\"margin-right: 20px;\">\n      <h4 class=\"primary bolder ui header\">Choose</h4>\n      <p style=\"color: gray;font-weight: 500\">Browse the result of SDS which is based on your personality and skills,\n        and pick the occupation you like</p>\n    </div>\n  </div>\n</section>\n\n\n\n\n<!-- End of Section -->\n<br>\n<br>\n\n\n\n<!-- Section -->\n<section>\n  <h1 class=\"bolder center primary\">The Self-Directed Search is for</h1>\n  <div class=\"ui grid container\">\n    <div class=\"four wide column\">\n      <div class=\"ui card\">\n        <div class=\"image\">\n          <img class=\"ui circular image\" src=\"assets/images/meeting.png\">\n        </div>\n        <div class=\"content\">\n          <a class=\"header center bolder\">Career Counselors</a>\n          <div class=\"description center\">\n            Enhance your counseling service by adding a psychometrically sound, widely used career interest inventory\n            to your assessment lineup.\n          </div>\n        </div>\n\n      </div>\n    </div>\n    <div class=\"four wide column\">\n      <div class=\"ui card\">\n        <div class=\"image\">\n          <img class=\"ui circular image\" src=\"assets/images/briefcase.png\">\n        </div>\n        <div class=\"content\">\n          <a class=\"header bolder center\">Career Transition</a>\n\n          <div class=\"description\">\n\n            Sometimes you just need a change—and sometimes a change is your only option. Find out what types of careers\n            are right for you now.\n\n          </div>\n        </div>\n\n      </div>\n\n    </div>\n    <div class=\"four wide column\">\n      <div class=\"ui card\">\n        <div class=\"image\">\n          <img class=\"ui circular image\" src=\"assets/images/soldier.png\">\n        </div>\n        <div class=\"content\">\n          <a class=\"header bolder center\">Veterans</a>\n\n          <div class=\"description\">\n\n            The transition to civilian life is uniquely challenging. Ease the shift by exploring career options that\n            correspond to your military experience.\n\n          </div>\n        </div>\n\n      </div>\n    </div>\n    <div class=\"four wide column\">\n      <div class=\"ui card\">\n        <div class=\"image\">\n          <img class=\"ui circular image\" src=\"assets/images/school.png\">\n        </div>\n        <div class=\"content\">\n          <a class=\"header bolder center\">Career Counselors</a>\n\n          <div class=\"description\">\n\n            Student life is filled with choices. Make the big one easier by discovering the majors, fields of study,\n            and jobs that fit your personality best.\n\n          </div>\n        </div>\n\n      </div>\n    </div>\n  </div>\n</section>\n<!-- End of Section -->\n<br>\n<br>\n\n\n<div class=\"ui placeholder segment container\">\n  <div class=\"ui two column very relaxed stackable grid\">\n    <div class=\"column\" style=\"margin-top:150px;\">\n      <h3 style=\"color:#808080;font-style:italic;font-weight: normal\">\n        “Choose a job you love, and you will never have to work a day in your life.”\n        <br><br><span style=\"font-size:1.6em;font-style:bold;color:#808080\">-Confucius</span>\n      </h3>\n    </div>\n\n    <div class=\"column\" style=\"margin-top:50px;\">\n      <h2 class=\"primary bolder center\">Self directed search video</h2>\n      <video controls width=\"500\" height=\"300\">\n        <source src=\"assets/videos/video.mp4\" type=\"video/mp4\">\n      </video>\n    </div>\n  </div>\n\n  <div class=\"ui vertical divider\">\n\n  </div>\n</div>\n\n\n<!-- Footer -->\n<div class=\"ui inverted vertical footer segment\">\n  <div class=\"ui container center\">\n    Gordon College All Rights Reserved\n  </div>\n</div>\n<!-- Footer -->"
...
module.exports = "@import url('https://fonts.googleapis.com/css?family=Staatliches');\r\nh4,h5{\r\n    margin:0;\r\n    font-family: 'Staatliches', cursive;\r\n}\r\nh3{\r\n    margin: 0 0 0 0;\r\n    font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;\r\n}\r\n.printContent{\r\n    width:940px;\r\n    height:100vh;\r\n    page-break-inside:avoid !important;\r\n}\r\n@media print {\r\n    #message{\r\n        color:black;\r\n    }\r\n    #print_header{\r\n        letter-spacing:0.2em;font-weight: bold;color:grey !important; \r\n    }\r\n    .ui.progress {\r\n        background-image: none;\r\n        -webkit-print-color-adjust: exact;\r\n        box-shadow: inset 0 0;\r\n        -webkit-box-shadow: inset 0 0;\r\n      \r\n      \r\n      }\r\n    \r\n \r\n    html, body {\r\n      /*changing width to 100% causes huge overflow and wrap*/\r\n      height:100%; \r\n      background: #FFF; \r\n      font-size: 9pt;\r\n    }\r\n    table{\r\n        page-break-inside: avoid;\r\n    }\r\n    \r\n  \r\n\r\n  }\r\n.onepage {\r\n    page-break-after: always;\r\n  }\r\n.onepage:last-child {\r\n    page-break-after: avoid;\r\n  }\r\n:host::ng-deep.ui.progress .label{\r\n    font-size: 1.2em;\r\n}\r\n:host::ng-deep.ui.progress#R .label{\r\n    color:#F1463C !important;\r\n}\r\n:host::ng-deep.ui.progress#I .label{\r\n    color:#F79517 !important; \r\n}\r\n:host::ng-deep.ui.progress#A .label{\r\n    color:#FFCF00 !important; \r\n}\r\n:host::ng-deep.ui.progress#S .label{\r\n    color:#01723B !important; \r\n}\r\n:host::ng-deep.ui.progress#E .label{\r\n    color:#0073A5 !important; \r\n}\r\n:host::ng-deep.ui.progress#C .label{\r\n    color:#9279B7 !important; \r\n}\r\n:host::ng-deep.ui.progress#R .bar{\r\n    background:#F1463C !important;\r\n}\r\n:host::ng-deep.ui.progress#I .bar{\r\n    background:#F79517 !important; \r\n}\r\n:host::ng-deep.ui.progress#A .bar{\r\n    background:#FFCF00 !important; \r\n}\r\n:host::ng-deep.ui.progress#S .bar{\r\n    background:#01723B !important; \r\n}\r\n:host::ng-deep.ui.progress#E .bar{\r\n    background:#0073A5 !important; \r\n}\r\n:host::ng-deep.ui.progress#C .bar{\r\n    background:#9279B7 !important; \r\n}\r\n.code-rate{\r\n    padding: 10px;\r\n}\r\n.image-icon{\r\n    margin:5px;\r\n}\r\n#try {\r\n    -webkit-clip-path: polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%);\r\n    clip-path: polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%);\r\n }\r\n.containerBox {\r\n    position: relative;\r\n    text-align: center;\r\n    color: black;\r\n}\r\n.center-text {\r\n    position: absolute;\r\n    top: 50%;\r\n    left: 50%;\r\n    -webkit-transform: translate(-50%, -50%);\r\n            transform: translate(-50%, -50%);\r\n  }\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ChatService = /** @class */ (function () {
    ...
    ChatService.prototype.getMessages = function (convo_name, limit) {
